...
Similarly, Firsov and Uustalu have implemented certified CYK parsing~\cite{cyk-parsing} and the necessary certified grammar normalization~\cite{firsov-uustalu}.
For the sake of simplicity, we avoid such syntactic transformations in our
work.
